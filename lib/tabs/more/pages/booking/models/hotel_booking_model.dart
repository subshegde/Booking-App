...
class BookingManager {
  ...
  static Future<bool> addBooking(HomeBookingModel booking) async {
    try {
      final result = await DatabaseHelper().insertHotelBooking(booking.toMap());
...
// Get All Bookings for a Specific User
  static Future<List<HomeBookingModel>> getAllBookings(int userId) async {
    final bookingsData = await DatabaseHelper().getAllHotelBookings(userId);
  ...
  Future<void> removeBooking(int id) async {
    await DatabaseHelper().removeHotelBookingById(id);
  }
}
